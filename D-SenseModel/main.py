...
tasks = {
        ...
        'Cross-location-Orientation':     'Cross-location Orientation recognition', # T = 24
        'Cross-user-Orientation':         'Cross-user Orientation recognition',  # T = 25
        'Cross-gesture-Orientation':      'Cross-gesture Orientation recognition',  # T = 26
        'Cross-orientation-Location':     'Cross-orientation Location recognition',  # T = 27
        'Cross-gesture-Location':         'Cross-gesture Location recognition',  # T = 28
        'Cross-user-Location':            'Cross-user Location recognition'  # T = 29
        }
...
test_set_ratio    = 0.2;                   ADP_dir         = '/home/wzl/paper/TMC/0.04'
                                         # domain_idx      = domains[I] 'I IN [0, 4]' (Cross-location/orientation)
                                         # domain_idx      = domains[I] 'I IN [0, 5]' (Cross-gesture)
                                         # domain_idx      = domains[I] 'I IN [0, 2]' (Cross-user)
domains           = [1, 2, 3, 4, 5, 6];    domain_idx      = domains[1]
...
use_DWM           = True
# task_, model_   = list(tasks.items())[T], models[M] 'T IN [0, 29], M IN [0, 6]'
task_, model_     = list(tasks.items())[-1], models[0] # Select Task and Model
